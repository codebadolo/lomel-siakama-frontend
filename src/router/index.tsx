...
const MatieresPage         = lazy(() => import('@/pages/matieres/MatieresPage'))
const AnneesScolairesPage  = lazy(() => import('@/pages/annees-scolaires/AnneesScolairesPage'))

const Suspensed = ({ children }: { children: React.ReactNode }) => (
  <Suspense fallback={<div className="flex-1 flex items-center justify-center"><div className="w-6 h-6 border-2 border-emerald-600 border-t-transparent rounded-full animate-spin" /></div>}>
    {children}
  </Suspense>
)
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'matieres',         element: <Suspensed><MatieresPage /></Suspensed> },
          ...
          { path: 'annees-scolaires', element: <Suspensed><AnneesScolairesPage /></Suspensed> },
          // Routes promoteur
